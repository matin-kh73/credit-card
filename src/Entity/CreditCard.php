...
class CreditCard
{
    ...
    public function addEdit(CreditCardEdit $edit): self
    {
        if (!$this->edits->contains($edit)) {
            $this->edits->add($edit);
            $edit->setCreditCard($this);
        }
        return $this;
    }

    public function removeEdit(CreditCardEdit $edit): self
    {
        if ($this->edits->removeElement($edit)) {
            if ($edit->getCreditCard() === $this) {
                $edit->setCreditCard(null);
            }
        }
        return $this;
    }

    public function getEditService(): ?CreditCardEditService
    {
        return $this->editService;
    }

    public function setEditService(?CreditCardEditService $editService): self
    {
    ...
    {
        return $this->editService?->getEffectiveValue($this, 'name') ?? $this->name;
    }

    public function getEffectiveDescription(): ?string
    {
        return $this->editService?->getEffectiveValue($this, 'description');
    }

    public function getEffectiveAnnualEquivalentRate(): float
    {
        return $this->editService?->getEffectiveValue($this, 'annualEquivalentRate') ?? $this->annualEquivalentRate;
    }

    public function getEffectiveFirstYearFee(): float
    {
        return $this->editService?->getEffectiveValue($this, 'firstYearFee') ?? $this->firstYearFee;
    }

    public function getEffectiveAnnualCharges(): float
    {
        return $this->editService?->getEffectiveValue($this, 'annualCharges') ?? $this->annualCharges;
    }

    public function getEffectiveTransactionCosts(): float
    {
        return $this->editService?->getEffectiveValue($this, 'transactionCosts') ?? $this->transactionCosts;
    }

    public function hasEffectiveRewardProgram(): bool
    {
        return $this->editService?->getEffectiveValue($this, 'hasRewardProgram') ?? $this->hasRewardProgram;
    }

    public function hasEffectiveInsurance(): bool
    {
        return $this->editService?->getEffectiveValue($this, 'hasInsurance') ?? $this->hasInsurance;
    }

    public function hasEffectiveLuggageInsurance(): bool
    {
        return $this->editService?->getEffectiveValue($this, 'hasLuggageInsurance') ?? $this->hasLuggageInsurance;
    }

    public function getEffectiveSpecialFeatures(): ?string
    {
        return $this->editService?->getEffectiveValue($this, 'specialFeatures') ?? $this->specialFeatures;
    }

    public function getEffectiveRating(): float
    {
        return $this->editService?->getEffectiveValue($this, 'rating') ?? $this->rating;
    }
}
